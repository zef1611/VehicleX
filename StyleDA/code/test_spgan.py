...
parser.add_argument('--source_path',default='../datasets/sys2real/trainA/',type=str, help='./source dataset')
parser.add_argument('--save_path',default='../datasets/sys2real/trainA_AIC/',type=str, help='./source dataset')
parser.add_argument('--checkpoint',default='./checkpoints/sys2real/sys2AIC.ckpt',type=str, help='./source dataset')
